...
# exploration_state_tracker = add_agent(CustomAgents.create_exploration_state_tracker, llm_config)
# exploration_aspect_promoter = add_agent(CustomAgents.create_exploration_aspect_promoter, llm_config)
...
# severity_state_tracker = add_agent(CustomAgents.create_severity_state_tracker, llm_config)
# severity_aspect_promoter = add_agent(CustomAgents.create_severity_aspect_promoter, llm_config)
# dmind_state_tracker = add_agent(CustomAgents.create_dmind_state_tracker, llm_config)
# dmind_aspect_promoter = add_agent(CustomAgents.create_dmind_aspect_promoter, llm_config)
# client_profile_state_tracker = add_agent(CustomAgents.create_client_profile_state_tracker, llm_config)
# client_profile_aspect_promoter = add_agent(CustomAgents.create_client_profile_aspect_promoter, llm_config)
# session_flow_state_tracker = add_agent(CustomAgents.create_session_flow_state_tracker, llm_config)
# session_flow_aspect_promoter = add_agent(CustomAgents.create_session_flow_aspect_promoter, llm_config)
...
while True:
    try:
        ...
        # severity_state_summary_result = user_proxy.initiate_chat(
        #     recipient=severity_state_tracker,
        #     message="",
        #     max_turns=1,
        ...
        # session_flow_state_tracker_result = user_proxy.initiate_chat(
        ...
        #         f"[Severity Result] {str(severity_state_summary_result.summary)}"
        #     ]
        # )
        # session_flow_aspect_promoter_result = user_proxy.initiate_chat(
        #     recipient=session_flow_aspect_promoter,
        #     message="",
        #     max_turns=1,
        #     summary_method="last_msg",
        #     carryover=[
        #         f"[Dialogue History] {str(dialogue_history)}",
        #         f"[Current Stage] {str(session_flow_state_tracker_result.summary)}",
        #     ]
        # )
        ...
        bot_answer = main_problem_result_aspect_promoter.summary
        print(bot_answer)
        print('-' * 15)
        ...
        # dmind_state_summary_result = user_proxy.initiate_chat(
        #     recipient=dmind_state_tracker,
        #     message="",
        #     max_turns=1,
        #     summary_method="last_msg",
        #     carryover=[f"[Dialogue History] {str(dialogue_history)}"]
        ...
        # dmind_aspect_promoter_result = user_proxy.initiate_chat(
        #     recipient=dmind_aspect_promoter,
        #     message="",
        #     max_turns=1,
        #     summary_method="last_msg",
        #     carryover=[
        #         f"[Dialogue History] {str(dialogue_history)}",
        #         f"[DMIND Summary] {str(dmind_state_summary_result.summary)}",
        #     ]
        # )

        # client_profile_state_summary_result = user_proxy.initiate_chat(
        #     recipient=client_profile_state_tracker,
        #     message="",
        #     max_turns=1,
        #     summary_method="last_msg",
        #     carryover=[f"[Dialogue History] {str(dialogue_history)}"]
        ...
        # client_profile_aspect_promoter_result = user_proxy.initiate_chat(
        #     recipient=client_profile_aspect_promoter,
        #     message="",
        #     max_turns=1,
        #     summary_method="last_msg",
        #     carryover=[
        #         f"[Dialogue History] {str(dialogue_history)}",
        #         f"[Client Profile Summary] {str(client_profile_state_summary_result.summary)}",
        #     ]
        # )

        # end_session_state_summary_result = user_proxy.initiate_chat(
        ...
        # end_session_aspect_promoter_result = user_proxy.initiate_chat(
        ...
        #     carryover=[
        #         f"[Dialogue History] {str(dialogue_history)}",
        #         f"[End Session Summary] {str(end_session_state_summary_result.summary)}",
        #     ]
        # )
